    ...
    public class DatabaseNode
    {
        ...
        public ICollection<ServerOrApplianceNode> GetUpstreamServerOrApplianceDependencies()
        {
            using (AOCMDBContext _dbContext = new AOCMDBContext())
            {
                ...
                foreach (DatabaseToServerOrApplianceDependency DataDep in _dbContext.DatabaseToServerOrApplianceDependencys.Where(P => P.DownstreamDatabaseId == DatabaseId).ToList())
                {
