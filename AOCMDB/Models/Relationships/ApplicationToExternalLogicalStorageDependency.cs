...
{
    public class ApplicationToExternalLogicalStorageDependency
    {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////
        /////////////////////////////////////////////////////////////////////////////////////////////////////////
        //AOCMDB Details
        ...
        [Column(Order = 3)]
        [Required]
        [Display(Name = "Upstream ExternalLogicalStorage ID", Description = "Internal ID of the External Logical Storage")]
        public long UpstreamExternalLogicalStorageNodeNodeID { get; set; }

        public ExternalLogicalStorageNode GetUpstreamExternalLogicalStorage()
        {
            using (AOCMDBContext _dbContext = new AOCMDBContext())
            {
                return _dbContext.ExternalLogicalStorages.Find(UpstreamExternalLogicalStorageNodeNodeID);
            }
        }
    }
}